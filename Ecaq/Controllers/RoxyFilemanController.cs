...
namespace Ecaq.Controllers
{
    ...
    //[Authorize(Roles = "Superadmin,Admin")] // Important: uncomment this in production to prevent huge security risk!
    ...
    public class RoxyFilemanController : Controller
    {
        ...
        private string _systemWebRootPath;
        ...
        public RoxyFilemanController(IWebHostEnvironment env)
        {
            ...
            _systemWebRootPath = env.WebRootPath;
            _tempPath = _systemWebRootPath + "\\myassets\\Temp";
            _filesRootPath = "/myassets/uploads";
            _filesRootVirtual = "/myassets/uploads";
        ...
        {
            _settings = JsonSerializer.Deserialize<Dictionary<string, string>>(System.IO.File.ReadAllText(_systemWebRootPath + "/lib/fileman/conf.json"));
            string langFile = _systemWebRootPath + "/lib/fileman/lang/" + GetSetting("LANG") + ".json";
            if (!System.IO.File.Exists(langFile)) langFile = _systemWebRootPath + "/lib/fileman/lang/en.json";
            _lang = JsonSerializer.Deserialize<Dictionary<string, string>>(System.IO.File.ReadAllText(langFile));
        }
        ...
        public IActionResult DIRLIST(string type)
        {
            try
            {
                ...
                string localPath = _systemWebRootPath;
                string result = "";
        ...
        */
        ...
        private string FixPath(string path)
        {
            ...
            return _systemWebRootPath + path;
        }
