...
namespace Ecaq.Data.Migrations
{
    ...
    [Migration("20240507053120_addNewsModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecaq.Models.AboutModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("StatAlianceValue")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StatAllianceText")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StatChurchesText")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StatChurchesValue")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StatMembersText")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StatMembersyValue")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StatNationalityText")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("StatNationalityValue")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Ecaq.Models.HomeBanner", b =>
                {
                    ...
                    b.Property<bool>("ButtonUrlExternal")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Ecaq.Models.NewsModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecaq.Models.AllianceCollectionModel", b =>
                {
                    b.HasOne("Ecaq.Models.AllianceModel", "AllianceModel")
                        .WithMany("AllianceCollectionModels")
                        .HasForeignKey("AllianceModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AllianceModel");
                });
            ...
            modelBuilder.Entity("Ecaq.Models.AllianceModel", b =>
                {
                    b.Navigation("AllianceCollectionModels");
                });
